...
export const DiagnosisCTA: React.FC<DiagnosisCTAProps> = ({
    ...
    return (
        <div className="my-10 flex flex-col items-center justify-center">
            ...
            <Link
                href="/diagnosis"
                className="group relative flex flex-col items-center justify-center bg-[#00B5AD] text-white px-12 py-5 rounded-[40px] shadow-[0_8px_30px_rgb(0,181,173,0.3)] hover:shadow-[0_12px_40px_rgb(0,181,173,0.4)] hover:-translate-y-1 transition-all duration-300 w-full max-w-sm sm:max-w-md"
            >
                ...
                <span className="text-sm md:text-base font-serif tracking-[0.2em] mb-1 opacity-90 uppercase">
                    {title}
                </span>
