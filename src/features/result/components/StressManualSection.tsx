            ...
            {hasOsData && (
                <div className="grid md:grid-cols-2 gap-4 mb-6">
                    <div className="bg-red-50 p-4 rounded-lg border border-red-100">
                        <h4 className="font-bold text-red-800 mb-2 text-sm">ストレス下の反応</h4>
                        <p className="text-sm text-red-900 leading-relaxed">
                            <FormattedText text={osData.psychology.stressResponse} />
                        </p>
                    </div>
                    <div className="bg-emerald-50 p-4 rounded-lg border border-emerald-100">
                        <h4 className="font-bold text-emerald-800 mb-2 text-sm">回復のヒント</h4>
                ...
                <div className="space-y-5">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            {[
                                { time: '5分', label: '応急処置', content: manual.recovery.quick, color: 'bg-prisma-50 border-prisma-100' },
                                { time: '30分', label: 'ちゃんと休む', content: manual.recovery.medium, color: 'bg-blue-50 border-blue-100' },
                                { time: '1日', label: 'フルリセット', content: manual.recovery.full, color: 'bg-indigo-50 border-indigo-100' },
