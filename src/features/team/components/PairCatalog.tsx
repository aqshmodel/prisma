    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {filteredPairs.map((pair, index) => {
          ...
          return (
            <div key={index} className="bg-white rounded-2xl p-2 sm:p-4 md:p-6 shadow-sm border border-slate-200 hover:border-teal-300 hover:shadow-md transition-all flex flex-col h-full group">
              ...
              <div className="relative mb-5 mt-2">
                ...
                <div className="grid grid-cols-2 gap-1.5 sm:gap-3">
                  {[pair.memberA, pair.memberB].map((member, i) => {
                    ...
                    return (
                      <div key={i} className="bg-slate-50 rounded-xl p-1.5 sm:p-3 border border-slate-100 flex flex-col relative h-full">
